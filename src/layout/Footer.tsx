import "./Footer.scss";
import HaroldGraphsWordMark from "../assets/images/HaroldGraphsWordMark.png";
		...
		<div className="FooterContainer">
			<div className="FooterHolder">
				<div className="Footer__ReachOut">
					...
					<Button
						variant="contained"
						href="https://mail.google.com/mail/u/1/#inbox?compose=GTvVlcSKkHfzVKNDDnTTVRcHtJXXkqhBntWtSrCcvHTHBnDFMBsVQrNFTWPGMlLvJlvNgNFMnMChR"
				...
				<div className="Footer__Content">
					<div className="Footer__Logo">
						<a href="#Head">
							<img src={HaroldGraphsWordMark} alt="" />
						</a>
					</div>
					<div className="FooterRight">
						<div className="Footer__SiteMap">
							<p className="Footer__Title">Site map</p>
							<ul className="Footer__List">
								<li>
									<a href="#AboutMe">
										<p className="BodyText3">About</p>
									</a>
								</li>
								<li>
									<a href="#MyProjects">
										<p className="BodyText3">My Projects</p>
									</a>
								</li>
								<li>
									<a href="">
