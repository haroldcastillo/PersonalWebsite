...
import RibbonEnd from "../../assets/images/RibbonEnd.png";
...
interface CardProps {
    ...
    setModalValue?: React.Dispatch<React.SetStateAction<DataType>>;
    setActive: React.Dispatch<React.SetStateAction<boolean>>;
    setModalData: React.Dispatch<React.SetStateAction<DataType | undefined>>;
}
...
function ProjectCard(props: CardProps) {
    ...
    return (
        <motion.div
            ref={ref}
            className={
                props.Type == "Right" ? "ProjectCard Right" : "ProjectCard Left"
            }
            variants={{
        ...
        >
            <div className="ProjectCard__ImageContainer">
                <div className="ProjectCard__ImageHolder">
                    <ImageFinder Image={props.Data.ID} />
                </div>
                <div className="ProjectCard__ToolsContainer">
                    <div className="ProjectCard__ToolsHolder">
                        <div>
                            {!(props.Data.Illustrator === "") ? (
                                <img src={IllustratorLogo} alt="Illustrator" />
                            ) : (
                                ""
                            )}
                            {!(props.Data.AfterEffects === "") ? (
                                <img
                        ...
                        <img
                            className="ProjectCard__ToolsHolderEnd"
                            src={RibbonEnd}
                            alt=""
                        />
                    </div>
            ...
            <div className="ProjectCard__ContentHolder">
                <h6 className="ProjectCard__Title">{props.Data?.Title}</h6>
                <div className="ProjectCard__Infos">
                    <p className="BodyText1 ProjectCard__Role">
                        {props.Data.Role}
                    </p>
                    <div className="ProjectCard__Calendar">
                ...
                <div className="ProjectCard__Buttons">
                    <div className="ProjectCard__ViewCaseHolder">
                        <Button
                            onClick={() => {
                                props.setActive(true);
                                props.setModalData(props.Data);
                            }}
                            className="ProjectCard__ViewCase"
                            variant="contained"
                        >
                            View Use Case
                        </Button>
                    </div>
                    <div className="ProjectCard__SocialMedia">
                        <a
